...
# Name the container group.
library(XML)
svg1 <- list.files(path='/home/jzhan067/SVG_tutorial_file/anatomogram/src/svg/svg_trans', pattern='.svg$', full.names=T)
path.out <- '/home/jzhan067/SVG_tutorial_file/anatomogram/src/svg/svg_trans'
